...
public class stackClass {
	...
	public void push(int val) {
		N newNode = new N(val); // Creates a node from the passed value
		...
		if (this.first == null) {
			...
			N temp = this.first; // Preserves the current top node
	...
	public int pop() {
		...
		N temp = this.first; // Creates a node variable to be returned
